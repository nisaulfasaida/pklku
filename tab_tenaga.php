          ...
          <div class="row">
            <div class="col-lg-12">
              <ol class="breadcrumb">
                ...
                <li><i class="icon_documents_alt"></i><a href="tab_bahan.php">Tenaga Kerja</a></li>
              </ol>
            </div>
          </div>
        <div class="row">
            <div class="col-lg-12">
              <a class="btn btn-info" href="form_tenaga.php" title="Bootstrap 3 themes generator"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Tenaga Kerja</a>
              <a class="btn btn-success" target="_blank" href="pdf_tenagaa.php" title="Bootstrap 3 themes generator">Cetak Tabel (Pdf)</a>
              <br><br>
