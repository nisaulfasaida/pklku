    ...
    ?>
      ...
      <section id="main-content">
          <section class="wrapper">            
		    ...
		    <div class="row">
                  <div class="col-lg-12">
					  <a class="btn btn-info" href="form_bahan.php" title="Bootstrap 3 themes generator">Tambah Bahan Baku</a>
					  <a class="btn btn-success" href="pdf_bahann.php" title="Bootstrap 3 themes generator">Cetak Tabel (Pdf)</a>
					  <br></br>
                      <section class="panel">                          
						  ...
						  <table class="table table-condensed" id="id_tabel">
                           <tbody>
                              <tr>
                                 <th>No</th>
