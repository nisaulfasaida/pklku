...
<?php
  ...
  $no_proyek = $_GET['idp'];
    ...
    $no_proyek = $no_proyek;
		...
		$query = "INSERT INTO analisis_tenaga_kerja (kode_tenaga, no_analisis, perkiraan, no_proyek) VALUES('$tenagakerja', '$analisis', '$perkiraan', '$no_proyek')";
...
<html lang="en">
  <head>
    ...
    <title>Tambah Analisis Tenaga Kerja</title>
     ...
     <!--main content start-->
      <section id="main-content">
		  ...
		  <div class="row">
            ...
            <li><i class="fa fa-plus"></i>Tambah Analisis Pekerjaan</a></li> 
					</ol>
				</div>
			</div>
              <!-- Form validations -->              
